        ...
        <div class="-m-1.5 overflow-x-auto">
            <div class="p-1.5 min-w-full inline-block align-middle">
                <div class="overflow-hidden">
                    <div class="border-b pb-1 text-sm">{!! $vehicles->count() !!} {!! __('Vehicles') !!}</div>
                    @if($vehicles)
                        {{--
                        Small Screens
                        --}}
                                ...
                                @foreach($vehicles as $vehicle)
                                    ...
                                    >
                                        <div class="flex justify-between items-center">
                                            @if($vehicle->active)
                                                {{--Active--}}
                                                <span class="font-semibold">{{ $vehicle->vehicle_make }} &middot; {{ $vehicle->vehicle_model }}</span>
                                                <span><x-heroicon-o-check-circle class="h-4 w-4 text-green-700"/></span>
                                            @else
                                                {{--Inactive--}}
